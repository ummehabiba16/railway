...
function SearchTrainForm() {
  ...
  const handleBookSelectedSeats = async () => {
    ...
    try {
      const response = await api.post("/book/seats", {
                          ...
                          bookingResponse[0].classId === cls.classId && (
                            <>
                              <div className="mt-3">
                                ...
                                coachWiseTicketResponse.trainId === train.trainId &&
                                coachWiseTicketResponse.classId === cls.classId &&
                                coachWiseTicketResponse.coachId === coach.coachId && (
                                  <div className="mt-4">
                                    <div className="card">
                                      <div className="card-header">
                                        <h5 className="mb-0">
                                          Select Your Seats - Coach: {
                                            bookingResponse.find(coach => 
                                        ...
                                        <div className="coach-layout">
                                          <div className="row justify-content-center">
                                            ...
                                            {Array.from(
                                              {
                                                length: Math.ceil(
                                                  coachWiseTicketResponse.tickets.length /
                                                    5
                                                ),
                                              },
                                              (_, rowIndex) => {
                                                ...
                                                const rowSeats =
                                                  coachWiseTicketResponse.tickets.slice(
                                                    startIndex,
                                                    startIndex + 5
                                                  );
                                                          ...
                                                          .map(
                                                            (
                                                              ...
                                                              <div
                                                                ...
                                                                className={`seat-box ${getSeatColor(
                                                                  ticket
                                                                )} ${
                                                                  ticket.ticketStatus ===
                                                                  "AVAILABLE"
